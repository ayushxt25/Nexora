...
List fields (interests, themes, suggestions) are stored as delimited text
columns rather than a separate normalized table, since they're always read
and written as a whole alongside their parent entry -- introducing extra
tables here would add joins without a corresponding benefit.
"""
